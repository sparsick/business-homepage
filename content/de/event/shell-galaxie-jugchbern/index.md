...
<div style="display: grid; row-gap: 50px; max-height: 100%; ">
  <div style="display: inline-grid;">
    <iframe src="https://mastodon.social/@sparsick/110539069265840977/embed" class="mastodon-embed" style="max-width: 100%; border: 0" width="400" allowfullscreen="allowfullscreen"></iframe><script src="https://mastodon.social/embed.js" async="async"></script>
  </div>
